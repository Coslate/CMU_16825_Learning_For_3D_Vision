...
2. Run:
 ...
 #Question 3.3
 #Train
  python train_model.py --type 'point' --save_freq 600 --lr_sch_on 1 --n_point 5000 --max_iter 8001 --lr 9e-5 --batch_size 32 --num_workers 14 --early_stop_iter 601 --output_path ./outputs_full_point_model4_max_iter8001_bz32_num_workers_8_lr_9e-5_lr_sch_on_1_n_points_5000
