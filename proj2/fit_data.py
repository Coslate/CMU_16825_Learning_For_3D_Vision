...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        render_voxel_mesh(voxels_src=voxels_src, is_logit=True, dist=3, num_views=36, device_tag=args.device, image_size=512, output_path = "./outputs/q1.1_optimized.gif", fps=13)
        render_voxel_mesh(voxels_src=voxels_tgt, is_logit=False, dist=3, num_views=36, device_tag=args.device, image_size=512, output_path = "./outputs/q1.1_groundtruth.gif", fps=13)
        ...
        render_point_cloud(src_points=pointclouds_src, image_size=512, device_tag=args.device, num_views=36, fps=13, dist=3, radius=0.03, output_path="./outputs/q1.2_optimized.gif")
        render_point_cloud(src_points=pointclouds_tgt, image_size=512, device_tag=args.device, num_views=36, fps=13, dist=3, radius=0.03, output_path="./outputs/q1.2_groundtruth.gif")
        ...
        render_pure_mesh(mesh_src=mesh_src, dist=3, num_views=36, device_tag=args.device, image_size=512, output_path = "./outputs/q1.3_optimized.gif", fps=13)
        render_pure_mesh(mesh_src=mesh_tgt, dist=3, num_views=36, device_tag=args.device, image_size=512, output_path = "./outputs/q1.3_groundtruth.gif", fps=13)
