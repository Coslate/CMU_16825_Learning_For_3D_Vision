...
def dolly_zoom(
    ...
    for fov in tqdm(fovs):
        subject_size = 5  # TODO: change this.
        distances = subject_size/(2*np.tan(np.radians(fov/2))) # TODO: change this.
    ...
    imageio.mimsave(output_file, images, duration=duration, loop=0, palettesize=256)
